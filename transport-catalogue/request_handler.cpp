...
std::optional<trasport_catalogue::RouteInfo> RequestHandler::GetBusStat(const std::string_view bus_number) const {
    trasport_catalogue::RouteInfo bus_stat{};
    const trasport_catalogue::Bus* bus = catalogue_.GetBus(bus_number);
